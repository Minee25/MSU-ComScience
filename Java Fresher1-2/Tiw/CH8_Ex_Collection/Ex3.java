...
public class Ex3 {
  ...
  void display(ArrayList<Double> score) {
  ...
  String addFirst(ArrayList<Double> score) {
    Double addScore = input("Add first: ");
    score.addFirst(addScore);
    return "Data add successfully";
  }

  String addLast(ArrayList<Double> score) {
    score.addLast(input("Add Last: "));
    return "Data add successfully";
  }

  String addBefore(ArrayList<Double> score) {
  ...
  String addAfter(ArrayList<Double> score) {
    Double addBefore = input("Location: ");
    int index = score.indexOf(addBefore);
    if (score.contains(addBefore)) {
      Double addScore = input("Add Score: ");
  ...
  String deleteData(ArrayList<Double> score) {
  ...
  String editData(ArrayList<Double> score) {
  ...
  String searchData(ArrayList<Double> score) {
