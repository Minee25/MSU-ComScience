...
public class Ex4 {
  ...
  void readFile(String fileName) {
    try {
      ...
      String fileNameDoc = "std.doc";
      FileWriter fileWriter = new FileWriter(fileNameDoc);

      // DateFormat dateFormat = new SimpleDateFormat("EEEE, MMMM dd, yyyy");
      // DateFormat dateFormatTime = new SimpleDateFormat(" HH : mm : ss");
      // String dateString = dateFormat.format(new Date());
      // String dateStringTime = dateFormatTime.format(new Date());
      // fileWriter.write("Date " + dateString + " ");
      // fileWriter.write("Time " + dateStringTime + "\n");

      ZoneId zid = ZoneId.of("Europe/London");
      LocalDateTime now = LocalDateTime.now(zid);  
      fileWriter.write("Date " + now.getDayOfWeek() + ", " + now.getMonth() + " " + now.getDayOfMonth() + ", " + now.getYear() + " ");
      fileWriter.write("Time " + now.getHour() + " : " + now.getMinute() + " : " + now.getSecond() + "\n");   
